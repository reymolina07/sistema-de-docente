...
<table style="text-align: left; width: 100%;" border="0" cellpadding="2" cellspacing="2">
  ...
  <tbody>
    <tr style="font-weight: bold;" align="center">
      <td colspan="1" rowspan="1" style="vertical-align: top;"><img src="membrete1.png" alt="q" width="1022" height="158"><br>
      </td>
    </tr>
    <tr style="font-weight: bold;" align="center">
...
<h4 style="background-color: rgb(198, 198, 214);">BUSQUEDA DE INSCRIPCION </h4>
</big></div>
</div>

<form action="impinsc.php" name="form1" method="post">
  <center>
  <fieldset style="border: 2px solid rgb(0, 0, 255); width: 400px;">
  <div align="center">
    <legend style="color: rgb(0, 0, 153); font-weight: bold; font-style: italic;" class="Estilo2"></legend>
      ...
      <tbody>
        <tr style="color: rgb(51, 51, 255); font-style: italic; font-weight: bold;">
          <td style="vertical-align: top; text-align: center;"> POR FAVOR
            INTRODUZCA EL NUMERO DE INSCRIPCIÓN<br>            </td>
          </tr>
        <tr>
          <td style="vertical-align: top; text-align: center;">
            <div style="text-align: center;">
              <div style="text-align: center;"><input name="numins" id="numins" title="Introduzca el numero de incripción del estudiante" size="14" maxlength="4" style="border: 1px solid rgb(0, 0, 255);"> </div>
            </div>            </td>
          </tr>
        <tr>
          <td colspan="1" rowspan="1" style="vertical-align: top; text-align: center;"> <br>            </td>
          </tr>
        <tr>
