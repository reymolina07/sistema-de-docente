...
<table style="text-align: left; width: 100%;" border="0" cellpadding="2" cellspacing="2">
  ...
  <tbody>
    <tr style="font-weight: bold;" align="center">
      <td colspan="1" rowspan="1" style="vertical-align: top;"><img src="membrete1.png" alt="q" width="1003" height="140"><br>
      </td>
    </tr>
    <tr style="font-weight: bold;" align="center">
...
<h4 style="background-color: rgb(198, 198, 214);">BUSCAR REPRESENTANTE </h4>
</big></div>
</div>

<form action="modrep2.php" name="form1" method="post">
  <center>
...
INTRODUZCA EL NUMERO DE CEDULA<br>
      ...
      <tr>
        ...
        <div style="text-align: center;"><input name="modrep" id="modrep" title="Introduzca el número de cédula del representante" size="14" maxlength="9" style="border: 1px solid rgb(0, 0, 255);"> </div>
        </div>
        </td>
      </tr>
      <tr>
