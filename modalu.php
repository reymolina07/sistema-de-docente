...
<table style="text-align: left; width: 100%;" border="0" cellpadding="2" cellspacing="2">
  ...
  <tbody>
    ...
    <tr style="font-weight: bold;" align="center">
      ...
      <img src="membrete1.png" alt="q" width="1045" height="117">      </td>
    </tr>
    <tr style="font-weight: bold;" align="center">
  ...
  <table style="width: 1115px; height: 195px; text-align: left; margin-left: auto; margin-right: auto;" border="0" cellpadding="5" cellspacing="0">
    ...
    <tbody>
      ...
      <tr>
        ...
        <table style="width: 197px; height: 36px;" align="center" border="0" cellpadding="5" cellspacing="9">
          <tbody>
            <tr>
...
<input name="cedalu" id="cedalu" title="CEDULA ESCOLAR" size="14" maxlength="9" style="border: 1px solid rgb(0, 0, 255);" value="<?php echo $cedalu; ?>" readonly="readonly" > </label></div>
 </td>
