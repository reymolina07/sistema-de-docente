<?php include("conectar.php");
 ...
 if ($ceddoc=="")
    {
     echo "<div align=\"center\"><br><h2><font color='blue'>Error: Introduzca la cédula del docente, sólo números</font></h2></div>";
...
<table style="text-align: left; width: 100%;" border="0" cellpadding="2" cellspacing="2">
  ...
  <tbody>
    <tr style="font-weight: bold;" align="center">
      <td colspan="1" rowspan="1" style="vertical-align: top;"><img src="membrete1.png" alt="q" width="1053" height="141"><br>
      </td>
    </tr>
    <tr style="font-weight: bold;" align="center">
...
El
formato de los campos, cedula&nbsp; debe ser "12345678" DEBEN SER 9 DIGITOS, la fecha en formato "21/05/1995"<br>
        </td>
      </tr>
<tr>
