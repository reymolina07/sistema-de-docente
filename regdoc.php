...
<tbody><tr><td style="color: rgb(0, 0, 153); font-weight: bold; font-style: italic; text-align: center;" width="150"><small> </small>
        ...
        <td colspan="3" rowspan="1" style="vertical-align: top;"><label> <input name="dirdoc" id="dirdoc" title="DIRECCIÓN DE HABITACIÓN" size="120" maxlength="120" style="border: 1px solid rgb(0, 0, 255);"> </label>
        </td>
      </tr>
      <tr>
...
<tbody><tr><td style="color: rgb(0, 0, 153); font-weight: bold; font-style: italic; text-align: center;" width="150"> <small> </small>
      ...
      <tr>
        ...
        <td style="vertical-align: top; text-align: center;"><label>  </label><label> <input name="espdoc" id="espdoc" title="DEDICACIÓN U OCUPACIÓN" size="30" maxlength="30" style="border: 1px solid rgb(0, 0, 255);" onKeyPress="return soloLetras(event)" > </label></td>
        <td style="vertical-align: top; text-align: center;"><label>  </label><label> <input name="teldoc" id="teldoc" title="TELÉFONO LOCAL" size="11" maxlength="11" style="border: 1px solid rgb(0, 0, 255);" onKeyPress="javascript:return validarNro(event)"> </label></td>
        <td style="vertical-align: top; text-align: center;"><label> <input name="celdoc" id="celdoc" title="TELÉFONO CELULAR" size="11" maxlength="11" style="border: 1px solid rgb(0, 0, 255);" onKeyPress="javascript:return validarNro(event)"> </label><label>  </label></td>
