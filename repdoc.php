...
function Header()
{
        ...
        $this->Cell(197,4, 'REPORTE GENERAL DE DOCENTES REGISTRADOS',0,1,'C'); 
 ...
 function cabeceraHorizontal($cabecera)
    {
        ...
        $this->CellFitSpace(34,7, 'CEDULA',0, 0 , 'C');
        $ejeX = $ejeX + 34;
        ...
        $this->CellFitSpace(28,7, 'PROFESION',0, 0 , 'C');
        $ejeX = $ejeX + 28;

        $this->RoundedRect($ejeX, 50, 27, 7, 2, 'FD');
        $this->CellFitSpace(27,7, 'ESPECIALIDAD',0, 0 , 'C');
    ...
    function datosHorizontal($datos)
    {
        ...
        foreach($datos as $fila)
        {
            ...
            $this->CellFitSpace(34,5, utf8_decode($fila['ceduladoc']),'R', 0 , 'C' );
            $this->CellFitSpace(48,5, utf8_decode($fila['nombredoc']),'R', 0 , 'C' );
            $this->CellFitSpace(48,5, utf8_decode($fila['apellidodoc']),'R', 0 , 'C' );
            $this->CellFitSpace(28,5, utf8_decode($fila['profesiondoc']),'R', 0 , 'C');
            $this->CellFitSpace(27,5, utf8_decode($fila['especialidaddoc']),0, 0 , 'C' );
