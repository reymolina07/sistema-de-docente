...
function Header()
{
        ...
        $this->Cell(197,4, 'REPORTE GENERAL DE REPRESENTANTES REGISTRADOS',0,1,'C'); 
 ...
 function cabeceraHorizontal($cabecera)
    {
        ...
        $this->CellFitSpace(27,7, 'CELULAR',0, 0 , 'C');
    ...
    function datosHorizontal($datos)
    {
        ...
        foreach($datos as $fila)
        {
            ...
            $this->CellFitSpace(34,5, utf8_decode($fila['cedularep']),'R', 0 , 'C' );
            $this->CellFitSpace(48,5, utf8_decode($fila['nombrerep']),'R', 0 , 'C' );
            $this->CellFitSpace(48,5, utf8_decode($fila['apellidorep']),'R', 0 , 'C' );
            $this->CellFitSpace(28,5, utf8_decode($fila['profesionrep']),'R', 0 , 'C');
            $this->CellFitSpace(27,5, utf8_decode($fila['celularrep']),0, 0 , 'C' );
